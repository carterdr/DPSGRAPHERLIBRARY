...
class Anarchy(GrenadeLauncher):
    def __init__(self):
        ...
        self.anarchy_initial_damage = 2*380 * self.surgex3_damage_buff
...
class Parasite(GrenadeLauncher):
    def __init__(self):
        self.reserves = 7
        super().__init__(self.reserves)
        self.base_damage = (37044 + 9751) * self.surgex3_damage_buff
...
class Interferance(GrenadeLauncher):
    def __init__(self):
        ...
        self.base_damage = (self.base_impact + self.base_explosive) * self.surgex3_damage_buff
        self.reload_time = 129/60
...
class Regnant(GrenadeLauncher):
    def __init__(self):
        ...
        self.el_damage = (28389 + 3832) * self.surgex3_damage_buff
...
class Prospector(GrenadeLauncher):
    def __init__(self):
        ...
        self.base_damage = (672 + 12231 + 2846 + 485*5) * self.surgex3_damage_buff
        self.reload_time = 129/60
...
class Cataphract(GrenadeLauncher):
    def __init__(self):
        ...
        self.mag_size_initial = 6
        self.mag_size_subsequent = 6
        self.base_damage = (15933 + 6570) * self.surgex3_damage_buff * 0.9819031767
        self.time_between_shots = 30/60
        self.reload_time = 123/60

    def printDps(self, buffPerc, mag_size = 17, isEnvious=True, isScatterSignal=False, name="Cataphract", damageTimes=[], placeInColumn=None):
        self._preparePrintDps_(name, damageTimes, placeInColumn)
        if isEnvious:
