...
class Acrius(Shotgun):
    def __init__(self, melee_shot_time=101/60, shot_melee_shot=104/60):
        ...
        self.base_damage_bs = ((2140.5*15) + 6960) * self.surgex3_damage_buff
        self.base_damage_hs = 42302 * self.surgex3_damage_buff
...
class Ikelos(Shotgun):
    def __init__(self):
        ...
        self.base_damage_bs = 12 * 925.5 * self.vorpal_damage_buff * self.surgex3_damage_buff
        self.base_damage_hs = 12305 * self.vorpal_damage_buff * self.surgex3_damage_buff
...
class FILO(Shotgun):
    def __init__(self):
        ...
        self.mag_size_subsequent = 1
        self.base_damage = 20269 * self.surgex3_damage_buff
...
class Heritage(Shotgun):
    def __init__(self):
        ...
        self.mag_size_subsequent = 1
        self.base_damage = 20269 * self.surgex3_damage_buff * self.kinetic_special_damage_buff
...
class Nessas(Shotgun):
    def __init__(self):
        ...
        self.mag_size_initial = 12
        self.mag_size_subsequent = 1
        self.base_damage = 20269 * self.surgex3_damage_buff * self.vorpal_damage_buff
...
class SeventhSeraph(Shotgun):
    def __init__(self):
        ...
        self.mag_size_initial = 6
        self.mag_size_subsequent = 1
        self.base_damage_bs = 12 * 1267.5 * self.surgex3_damage_buff * self.vorpal_damage_buff
        self.base_damage_hs = 16850 * self.surgex3_damage_buff * self.vorpal_damage_buff
...
class Wastelander(Shotgun):
    def __init__(self):
        ...
        self.mag_size_initial = 6
        self.mag_size_subsequent = 1
        self.base_damage_bs = 12 * 1267.5 * self.surgex3_damage_buff * self.vorpal_damage_buff * self.kinetic_primary_damage_buff
        self.base_damage_hs = 16850 * self.surgex3_damage_buff * self.vorpal_damage_buff * self.kinetic_primary_damage_buff
...
class FourthHorseMan(Shotgun):
    def __init__(self):
        ...
        self.base_damage_hs = 14217 * self.surgex3_damage_buff
        self.base_damage_bs = 12 * 1069.5 * self.surgex3_damage_buff
