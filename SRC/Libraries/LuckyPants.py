...
class WardensLaw(LuckyPants):
    def __init__(self):
        ...
        self.base_damage = 1859 * self.surgex3_damage_buff
...
class Malfeasance(LuckyPants):
    def __init__(self):
        ...
        super().__init__(self.reserves)
        self.mag_size = 20
        self.explosion_damage = 4 * 2249 * self.surgex3_damage_buff
        self.base_damage = 2307 * self.surgex3_damage_buff
