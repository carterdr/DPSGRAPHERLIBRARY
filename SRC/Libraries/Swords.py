...
class Lament(Sword):
    def __init__(self):
        ...
        self.attack_sequence = [
            {"damage": (10111 + 2528 * 2) * self.surgex3_damage_buff, "delay": 30/60, 
             "ammo_used": 1},  # Charged 1
            {"damage": (13481 + 2528 * 2) * self.surgex3_damage_buff, "delay": 37/60, 
             "ammo_used": 1},  # Charged 2
            {"damage": (40441 + 7583 * 2) * self.surgex3_damage_buff, "delay": 43/60, 
             "ammo_used": 2},  # Heavy
            {"damage": 10111 * self.surgex3_damage_buff, "delay": 31/60,
                "ammo_used": 1},              # Base 1
            {"damage": 10111 * self.surgex3_damage_buff, "delay": 55/60,
                "ammo_used": 1}              # Base 2
            # Reset to Charged 1
        ]
