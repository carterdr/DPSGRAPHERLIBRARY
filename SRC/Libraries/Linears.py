...
class Arbalest(Linear):
    def __init__(self):
        ...
        self.base_damage = 21253 * self.surgex3_damage_buff
...
class Cataclysm(Linear):
    def __init__(self):
        ...
        self.base_damage = 22721 * self.surgex3_damage_buff
...
class Taipan(Linear):
    def __init__(self, isaccelerated, mag_size_intial):
        if (mag_size_intial == 5):
            ...
            self.reserves = 25
        if (isaccelerated):
            self.base_damage = 52215 * .85 / 1.93282237
            self.charge_time = .5
            self.time_between_shots = 62/60
        else:
            self.base_damage = 53281 * .85 / 1.93282237
            self.charge_time = .533
...
class StormChaser(Linear):
    def __init__(self):
        ...
        self.base_damage = 33372 * self.surgex3_damage_buff * self.firing_line_damage_buff
...
class Briars(Linear):
    def __init__(self):
        ...
        self.base_damage = 32664 * self.surgex3_damage_buff * self.surrounded_enhanced_damage_buff
...
class Sleeper(Linear):
    def __init__(self):
        ...
        self.base_damage = 43951 * self.surgex3_damage_buff
...
class Lorentz(Linear):
    def __init__(self):
        ...
        self.time_between_shots = 64/60
        self.reload_time = 113/60
        self.base_damage = 42024 * .85 / 1.93282237 * self.surgex3_damage_buff
        self.mag_size_initial = 6
        self.mag_size_subsequent = 6
...
class QueenBreaker(Linear):
    def __init__(self):
        ...
        self.base_damage_short = 38951 / 1.93282237 * self.surgex3_damage_buff
        self.base_damage_long = 53934 / 1.93282237 * self.surgex3_damage_buff
        self.mag_size_initial = 5
    ...
    def printDps(self, buffPerc, isShort=False, name="QueenBreaker", damageTimes=[], placeInColumn=None):
        ...
        self.reload_time = (
            self.reload_time_short if isShort else self.reload_time_long)
...
class DoomedPartitioner(Linear):
    def __init__(self):
        ...
        self.time_between_shots = 86/60
        self.reload_time = 135/60
        self.base_damage = 32664 * self.surgex3_damage_buff
        self.mag_size_initial = 12
        self.mag_size_subsequent = 6
