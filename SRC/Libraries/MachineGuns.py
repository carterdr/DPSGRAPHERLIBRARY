...
class Xenophage(MachineGun):
    def __init__(self):
        ...
        self.base_damage = (13507 + 3025) * self.surgex3_damage_buff
...
class GrandOverture(MachineGun):
    def __init__(self):
        ...
        self.base_damage = 10442 * self.surgex3_damage_buff
        self.rocket_barrage_damage = 20 * (2097 + 7459) * self.surgex3_damage_buff
...
class ThunderLord(MachineGun):
    def __init__(self):
        ...
        self.base_damage = 2172 * self.surgex3_damage_buff
        self.lightning = 4089 * self.surgex3_damage_buff
...
class Retrofit(MachineGun):
    def __init__(self):
        ...
        self.base_damage = 1360 * self.surgex3_damage_buff
